const cursosData = [
    ...
    },
    {
        ...
        planEstudios: [
            ...
            { modulo: 2, titulo: "Diagnóstico Radiológico de Patología Pulpar y Periapical", temas: ["Cambios radiográficos en patología pulpar", "Diagnóstico diferencial de lesiones periapicales", "Limitaciones de la radiografía convencional", "Valor agregado del CBCT en el diagnóstico precoz"] },
            { modulo: 3, titulo: "Anatomía Dentaria y Periapical en Imagenología", temas: ["Anatomía radicular y del sistema de conductos", "Anatomia periapical y relación diente - estructuras vecinas"] },
            { modulo: 4, titulo: "Planificación del Tratamiento Endodóntico Guiado por Imagen", temas: ["Principios de planificación endodóntico asistida por CBCT", "Evaluación radiológica de conductos calcificados", "Diagnóstico y localizacion de conductos omitidos", "Imagenología aplicada a retratamientos endodónticos"] },
            { modulo: 5, titulo: "CBCT en Endodoncia Clínica Avanzada", temas: ["Indicaciones basadas en evidencia del CBCT", "Selección del FOV y parámetros de adquisición", "Interpretación multiplanar y tridimensional", "Identificación de anatomía compleja y conductos no localizados", "Casos clínicos donde el CBCT modifica la conducta terapéutica"] },
            ...
            { modulo: 7, titulo: "Integración Clínica y Casos Clínicos Certificables", temas: ["Análisis integral de casos clínicos reales", "Toma de decisiones basada en imagenología", "Integración clínico–radiológica en endodoncia", "Elaboración de informes radiológicos especializados"] },
    ...
    },
    {
        ...
        planEstudios: [
            ...
            { modulo: 2, titulo: "Evaluación Radiológica del Hueso Alveolar", temas: ["Análisis tridimensional del reborde alveolar", "Altura, ancho y morfología ósea", "Calidad y densidad ósea en CBCT", "Criterios radiológicos para la selección del implante"] },
            { modulo: 3, titulo: "Anatomía Radiológica Maxilofacial Aplicada", temas: ["Anatomía ósea del maxilar y la mandíbula", "Identificación de estructuras anatómicas de riesgo", "Variantes anatómicas y hallazgos incidentales", "Interpretación clínica para procedimientos quirúrgicos"] },
            { modulo: 4, titulo: "Radiología en Periodoncia", temas: ["Correlación clínico–radiográfica en enfermedad periodontal", "Tipos de pérdida ósea y defectos intraóseos", "Evaluación de furcas", "CBCT versus radiografía convencional en periodoncia"] },
            ...
            { modulo: 7, titulo: "Integración Clínica y Casos Clínicos", temas: ["Análisis integral de casos reales", "Toma de decisiones clínicas basadas en imagenología", "Enfoque multidisciplinario: implantología, periodoncia y radiología", "Recomendaciones para informes radiológicos"] },
            { modulo: 8, titulo: "Complicaciones Implantológicas y Periodontales", temas: ["Diagnóstico radiológico de periimplantitis", "Identificación de fallas tempranas y tardías", "Errores frecuentes en interpretación radiográfica", "Análisis de complicaciones clínicas"] }
        ]
    },
    {
        id: 4,
